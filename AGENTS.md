...
- При обнаружении недостоверных отметок, нереализованных требований или незакрытых пробелов AI обязан остановиться, не ставить ложную отметку о готовности и дать пользователю честное сообщение о проблеме с точным описанием того, что осталось сделать.
