...
**Гейт привязки тестов к контенту и разделение категорий тестов (TSR-02, TSR-10, ADR-0046, план [TestSuiteRestructuring](../Plans/TestSuiteRestructuring/README.md)).** Нормативное правило разделяет automation-тесты движка в `Source/**/Tests` на две категории с машинной проверкой границы:
