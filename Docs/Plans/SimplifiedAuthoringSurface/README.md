...
- [x] M3 — [Domain API](DomainApi.md): предусловия, единый API актора, объекты вместо DTO.
- [x] M4 — [Presentation Source](PresentationSource.md): источник презентации и автоматическая инвалидация.
- [x] M5 — [RH Cleanup](RhCleanup.md): один файл правил, удаление инфраструктуры.
