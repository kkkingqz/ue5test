...
> **Материализует:** раздел «Mods и override» [предложения](../../../Proposals/Archive/CommandValidatorAuthoringProposal.md).
> **Задачи:** CVA-12…13.
...
- [x] **CVA-12 — Явная заменяемость команды**
  - Зависимости: CVA-11.
...
- [x] Повторная регистрация обработчика для незаменяемой команды отклоняется.
- [x] Валидаторы чужих пакетов переживают законную замену.
- [x] Одна spec suite исполняется обоими хостами; копии на C++ нет.
- [x] Документация синхронизирована в том же change set.
