...
> **Материализует:** раздел 15 [предложения](../../../Proposals/Archive/GameplayServiceAuthoringProposal.md).
> **Задачи:** GSA-06…09.
...
- [x] **GSA-06 — Начальное состояние: игрок и торговец**
...
- [x] **GSA-07 — Инвентарь как поведение одной сущности**
  - Зависимости: GSA-06.
...
- [x] **GSA-08 — Сервис торговли и перевод покупки**
  - Зависимости: GSA-07.
...
- [x] **GSA-09 — Спеки и сквозная верификация**
  - Зависимости: GSA-08.
...
- [x] Торговец существует в состоянии, находится на рынке и владеет мечом и бронёй.
- [x] После покупки золото игрока уменьшилось ровно на цену, золото торговца увеличилось на неё же.
- [x] Купленный предмет — тот же экземпляр, что принадлежал торговцу, а не новый.
- [x] Покупка отсутствующего товара отклоняется до мутации.
- [x] В `textsystem` и `core` не появилось понятий торговли, инвентаря и предметов.
