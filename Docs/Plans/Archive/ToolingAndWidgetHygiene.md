...
**Цель:** устранить findings [Plan Audit Findings](../../Status/AuditFindings.md), каждый из которых ограничен одним файлом или одним инструментом и не требует изменений через границы слоёв.
...
- [AuditFindings](../../Status/AuditFindings.md)
