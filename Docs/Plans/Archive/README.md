...
| [UiFoundation](UiFoundation.md) | 2026-08-20 | Базовые композитные виджеты ядра с едиными конвейерами, масштабирование от 4K до 720p, многослойный документ с реконсиляцией, вложенные экземпляры и вкладки, слоистые темы и модальное подтверждение покупки в `rh` |
