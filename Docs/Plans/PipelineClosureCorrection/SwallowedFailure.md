...
- [ ] **PCC-05 — Результат подготовки и фиксации обязан быть потреблён**
...
- [ ] **PCC-06 — Атомарность документа проверена, а не заявлена**
  - Зависимости: PCC-05.
...
- [ ] **PCC-07 — Reset подчиняется тем же инвариантам, что и apply**
...
- [ ] **PCC-08 — Объявление capability ничего не меняет**
