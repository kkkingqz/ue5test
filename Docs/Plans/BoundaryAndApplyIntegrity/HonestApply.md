...
- [x] **BAI-07 — Тест отката смотрит на состояние, а не на количество**
  - Зависимости: BAI-06.
...
- [x] Пропуск reconcile при неразрешённом классе невозможен ни в одном из четырёх путей.
- [x] Утверждение о транзакционности репитера проверяемо и истинно.
- [x] Тест отката краснеет на состоянии, а не только на количестве детей.
