...
- [x] **BAI-10 — Границы на 1280×720 проверяются по обеим осям**
...
- [x] **BAI-11 — Снятие побочных эффектов и мёртвой поверхности**
...
- [x] Грамматика ключа одна во всех четырёх местах.
- [x] Оба переписанных теста краснеют на внесённой регрессии.
- [x] Объявленная поверхность либо используется, либо снята.
