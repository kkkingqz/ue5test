...
- [Declared Composite Adoption](DeclaredCompositeAdoption/README.md) — перевод трёх композитов локации на объявление, удаление специального мостика в планировщике, три полностью новых композита без C++ и перечислитель для отзывчивой раскладки. DCA-01…17.
