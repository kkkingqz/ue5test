...
- [ ] Команда из пакета исполняется в обоих хостах без правки ядра.
- [ ] Валидатор и событие из пакета работают на том же пути.
- [ ] Дубликат и `override` покрыты раздельными спеками.
- [ ] Guide описывает добавление команды одной регистрацией.
