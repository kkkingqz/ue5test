...
- [x] **CVA-04 — Общий execution scope**
  - Зависимости: CVA-03.
...
- [x] **CVA-05 — `fail()` в scope валидатора**
  - Зависимости: CVA-04.
...
- [x] **CVA-06 — API `validate` и идентичность**
  - Зависимости: CVA-05.
...
- [x] **CVA-07 — Разрешение target на заморозке**
  - Зависимости: CVA-06.
...
- [x] **CVA-08 — Адаптер к существующему реестру**
  - Зависимости: CVA-07.
...
- [x] Пакет объявляет policy для чужой команды без доступа к runtime-контексту.
- [x] Отказ несёт пространство имён объявившего пакета, а не владельца команды.
- [x] Произвольная ошибка Lua в валидаторе остаётся fault.
- [x] Отсутствующий target обнаруживается независимо от порядка модулей.
- [x] `validator_registry.lua`, `command_dispatcher.lua` и C++ не изменены.
