...
- [ ] **CEH-23 — Portable authoring/index/edit conformance**
...
- [ ] **CEH-24 — Slate binding and interaction conformance**
...
- [ ] **CEH-25 — Realistic scale and performance fixture**
...
- [ ] **CEH-26 — Финальный project gate и документация**
...
- [ ] Portable conformance закрывает provider/structural/reference/rename safety.
- [ ] Slate suite закрывает реальные user interactions.
- [ ] Scale fixture доказывает отсутствие per-keystroke full scans.
- [ ] CLI/Editor parity сохранён.
- [ ] Full project gate зелёный.
