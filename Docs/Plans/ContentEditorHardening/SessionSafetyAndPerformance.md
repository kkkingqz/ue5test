...
- [x] **CEH-18 — Единый navigation/selection gate**
...
- [x] **CEH-19 — External file watcher и stale-state UI**
...
- [x] **CEH-20 — Recovery/Draft для Dirty + Stale**
  - Зависимости: CEH-19.
...
- [x] **CEH-21 — Разделить edit events и expensive derived refresh**
...
- [x] **CEH-22 — Не терять diagnostics и multi-file result metadata**
...
- [x] Нельзя потерять edits простым click/navigation.
- [x] Stale file виден без попытки Save.
- [x] Dirty+Stale имеет recoverable workflow.
- [x] N typed characters не означают N full GameData reparses.
- [x] Init diagnostics видны.
- [x] Multi-file operation result не теряет affected-file information.
