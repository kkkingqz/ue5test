...
- [ ] **CEH-13 — Построить typed authoring reference index**
  - Зависимости: CEH-01.
...
- [ ] **CEH-14 — Перевести References, Delete и Pickers на единый typed index**
  - Зависимости: CEH-13.
...
- [ ] **CEH-15 — Отражать pending edits в reference views**
...
- [ ] **CEH-16 — Ввести Rename Impact model**
...
- [ ] **CEH-17 — Schema-aware rename, redirect policy и transaction safety**
  - Зависимости: CEH-16.
...
- [ ] Stable-ID-looking ordinary strings не считаются references.
- [ ] Delete не блокируется ложной строковой ссылкой.
- [ ] Dirty reference edit виден до Save.
- [ ] Resource picker не выполняет per-open full parse.
- [ ] Rename показывает external impact.
- [ ] Rename не меняет unrelated strings.
- [ ] Failure injection не оставляет silently half-renamed content set.
