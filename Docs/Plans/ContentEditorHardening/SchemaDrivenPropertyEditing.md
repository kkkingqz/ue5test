...
- [x] **CEH-06 — Разделить semantic field type и presentation hint**
...
- [x] **CEH-07 — Ввести Property Presence Model**
...
- [x] **CEH-08 — Расширить portable authoring edit model структурными operations**
...
- [x] **CEH-09 — Реализовать Add / Remove / Override / Reset Property**
...
- [x] **CEH-10 — Nested object editing**
...
- [x] **CEH-11 — Array Add / Remove / Reorder**
  - Зависимости: CEH-08.
...
- [x] **CEH-12 — Path-based UI metadata для nested и extension fields**
...
- [x] Integer slider сохраняет integer.
- [x] Absent/default/explicit различимы.
- [x] Add Property не создаёт arbitrary field.
- [x] Remove/Reset не пишет файл до Save.
- [x] Nested object использует ту же модель.
- [x] Array поддерживает Add/Remove/Reorder.
- [x] Candidate validation остаётся единым write gate.
