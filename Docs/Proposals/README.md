...
| [ImageResourceLookupOptimizationProposal](ImageResourceLookupOptimizationProposal.md) | accepted for planning | UI, Resources, Engine | Immutable $O(1)$ lookup и однократная подготовка resolved brush |
