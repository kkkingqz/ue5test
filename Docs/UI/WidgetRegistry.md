...
> **Проверки:** `GV2.Runtime.Presentation.*`, `GV2.UI.Consumers.*`, `GV2.UI.CapabilityObservabilityHarness`, `GV2.UI.CapabilityObservabilityCompositeSweep`, `GV2.Runtime.UI.ScreenPreflightPredictsDeepChildFailure`, инвентарь `/Game/UI` в automation.
