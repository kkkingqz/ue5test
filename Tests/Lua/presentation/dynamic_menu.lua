...
return {
    ...
    tavern_screen_structure_and_buttons = function()
        ...
        assert(btn_market.binding.args.target_location_id == "rh:location.city.market")

        local btn_gate = find_button(buttons, "travel_city_gate")
        assert(btn_gate ~= nil, "travel to gate button must exist")
        assert(btn_gate.binding.args.target_location_id == "rh:location.city.gate")
    end,
    ...
    gate_screen_structure_and_buttons = function()
        ...
        assert(btn_tavern.binding.args.target_location_id == "rh:location.city.tavern")
    end,
