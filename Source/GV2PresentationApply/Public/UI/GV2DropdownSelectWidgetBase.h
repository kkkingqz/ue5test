...
class GV2PRESENTATIONAPPLY_API UGV2DropdownSelectWidgetBase
...
private:
    ...
    GV2PresentationApply::FPreparedViewportScalePolicy PreparedPopupScale;
    float PreparedMaxPopupHeight = 0.0f;
    bool bHasPreparedPopupScale = false;
