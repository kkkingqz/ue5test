...
struct GV2PRESENTATIONAPPLY_API FGV2TabItemEntry
{
    GENERATED_BODY()
...
class GV2PRESENTATIONAPPLY_API UGV2TabContainerWidgetBase : public UCommonUserWidget, public IGV2UiPropertyHost
...
public:
    ...
    UFUNCTION(BlueprintPure, Category = "GV2|UI|Tabs")
    UUserWidget* GetActiveScreenWidget() const;

    UFUNCTION(BlueprintPure, Category = "GV2|UI|Tabs")
    UUserWidget* GetScreenWidgetForTab(FName InTabKey) const;
...
protected:
    ...
    UPROPERTY(Transient)
    TMap<FName, TObjectPtr<UUserWidget>> TabScreenWidgets;
