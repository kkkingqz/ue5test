...
{
    Null, Boolean, Integer, Number, String, Key, Text, StableId, Binding, Object, Array, Count
};
 ...
 */
struct GV2PRESENTATIONAPPLY_API FGV2UiPropertyCapability
{
 ...
 */
struct GV2PRESENTATIONAPPLY_API FGV2UiCapabilityTree
{
 ...
 */
class GV2PRESENTATIONAPPLY_API FGV2UiCapabilityBuilder
{
public:
