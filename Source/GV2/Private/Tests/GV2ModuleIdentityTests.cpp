...
bool FGV2ModuleIdentityTest::RunTest(const FString& Parameters)
{
    ...
    TestFalse(TEXT("engine_version is not empty"), Identity.EngineVersion.IsEmpty());
    ...
    TestTrue(TEXT("engine_version is MAJOR.MINOR"), Identity.EngineVersion.Equals(FString::Printf(TEXT("%d.%d"), ENGINE_MAJOR_VERSION, ENGINE_MINOR_VERSION)));
